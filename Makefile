...
SRC =  InverseRL.cpp Strategy.cpp aca2.cpp discountedRwdQlearning.cpp avgRewardQLearning.cpp Pagmoprob.cpp InferStrategy.cpp Simulation.cpp runEM.cpp PagmoMultiObjCluster.cpp
TARGET = inverseRL
