...
CXX = g++
CXXFLAGS = -O3 -g -std=gnu++17 -fopenmp
...
SRC =  InverseRL.cpp Strategy.cpp aca2.cpp discountedRwdQlearning.cpp avgRewardQLearning.cpp Pagmoprob.cpp PagmoMle.cpp Simulation.cpp runEM.cpp ParticleFilter.cpp FullyAdapatedPF.cpp CPf-AS.cpp
TARGET = inverseRL
